...
<html>
	...
	<body class="bg-gray">
		...
		<div id="list" class="container mt40">
			...
			<div class="row  bg-white pad15 border-b" style="line-height: 32px;">
				<div class="font-16 col-xs-10" style="display: inline-block;padding: 0;">未提交人员提醒</div>
				<div class="col-xs-2" style="text-align: right;padding: 0;">
					<img id="Unsub" src="${pageContext.request.contextPath }/resource/img/sub.png" alt="${pageContext.request.contextPath }/resource/img/unsub.png" width="50px" onclick="openRceive()" />
				</div>
			</div>
			<div class="row  bg-white pad15 border-b "  id="approval_type">
				<div class="font-16 col-xs-11" style="display: inline-block;padding: 0;">提醒周期<span id="datashow" class="zhouqi" style="float:right;font-size: 1.6rem;color:#C0C0C0">请选择</span></div>
			...
			<div class="row bg-white pad15 border-b">
				<div class="font-16 col-xs-11 time_1" style="display: inline-block;padding: 0;" >
					<span>提醒时间 </span>
					<span class="apptime" style="float:right;font-size: 1.6rem;color:#C0C0C0">
		 			
		 			</span>
		 			<input onchenga="app()" value="请选择" class="" style="color:transparent;width:0%" readonly="readonly" name="appTime" id="appTime" type="text" >
				</div>
				<div class="col-xs-1" style="text-align: right;padding: 0;">
			...
			<div class="row  bg-white pad15 " id="mode">
				<div class="font-16 col-xs-11" style="display: inline-block;padding: 0;"><span>提醒方式 </span><span class="alert_show" style="float:right;font-size: 1.6rem;color:#C0C0C0">请选择</span></div>
				<div class="col-xs-1" style="text-align: right;padding: 0;">
					<span class="glyphicon glyphicon-menu-right font-defalut " style="font-size: 2rem;color:#C0C0C0"></span>
				</div>
			</div>
	...
	<form id="setsubmit">
			<input type="hidden" id="setWay"  value="1"  name="reWay">
			<input type="hidden" id="modelId"  name="modelId" value="${modelId}">
			<input type="hidden" id="setCycle" name="reCycle">
			<input type="hidden" id="setTime"  name="reTime" >
		</form>
		<!-- </div> -->
		<div class="approval-leave-type" >
			<div class="approval-leave-bg" ></div>
			<div class="approval-leave-choice"   style="height:56%;">
			
			 <div class="row" style="height: calc(100% - 50px);padding: 0 25px;border: none;overflow-y: auto;overflow-x: hidden;"></div>
			   <div class="row" id="submit_button"  style="border:none;margin:0 ;border-top: 1px solid #e7e7e7;">
...
<!--方式-->
		<div class="alert_mode" >
			<div class="approval-leave-bg" ></div>
			<div class="approval-leave-choice" >
			    <div class="font-16">
			    	应用内消息推送
			    </div>
		...
		<div class="approval-tima" style="display: none;">
					<div class="approval-leave-bg"></div>
					<div class="approval-leave-choice text-center"style="margin-top:0px;width:80%;border:none" >
		...
		<script src="${pageContext.request.contextPath }/resource/js/receive.js" type="text/javascript" charset="utf-8"></script>
	...
	<script>
			...
			$(document).ready(function(){
				...
				if($(".header-center").text()=="日报"){
						...
						var op='<div class="border-b"  onclick="check(this)" style="height:50px;line-height:50px;" ><span class="font-16">周一</span><div class="checkboxChoice pull-right" style="margin: 0;"><p class="checkboxChoice-p" style="right:10px;top: 14px;"></p><input type="checkbox"  class="hidden"  id="num_1" value="1" name="leave"></div></div>';
						
						for (var i=1;i<arr.length;i++) {
							var id="num_"+(i+1);
							var num=i+1;
							op+='<div class="border-b"  onclick="check(this)" style="height:50px;line-height:50px;"><span class="font-16">'+arr[i]+'</span><div class="checkboxChoice pull-right" style="margin: 0;"><p class="checkboxChoice-p" style="top: 14px;right:10px"></p><input type="checkbox" class="hidden"  id="'+id+'" value="'+num+'" name="leave"></div></div>'
						}
